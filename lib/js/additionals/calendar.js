        ...
        ({
            ...
            eventRender:function (event, element) {
                ...
                if (event.url == undefined) {
                   ...
                   element.attr('onclick', 'javascript:openModal("' + event.title + '","' + event.description + '","' + event.id + '","' + event.user_id + '" );');  }
                } else {
...
function openModal(title, info, id, user_id, color) {
    // Show mode
    $(".modal-body").html(info + user_id);
    $(".modal-header h4").html(title + user_id);
...
function openModal_URL(title, description, url, id, color, user_id) {
    ...
    $(".modal-header h4").html(title + 'das ist die user id ' + user_id);
    $("#cal_viewModal").modal('show');
